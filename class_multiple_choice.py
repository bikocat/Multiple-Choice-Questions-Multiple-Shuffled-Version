from empty_format import format_question
...
class multiple_choice_test:
    ...
    def produce_format(self,n_quest,n_choices):
    ...
    def output(self,N_test,path_format,path_output,path_original_answers):
        ...
        total_output=[shuffle(i,path_format,path_original_answers) for i in Student_seed]
        ...
        with open(path_output+ "Test_Correction.txt","w+",encoding="utf-8") as doc:
               doc.write(output_file.txt_answers_output(path_original_answers,answers_string))
